...
// TODO: talal suggesiton: folders for notes
// and offset the positioning of the notes
...
class Note extends Component {
	...
	// props vs state: props come from above
	// states stay for the component to keep track of its own changes.
   ...
   */
	...
	renderDisplay() {
		...
		return (
			<div className="note" style={this.style} draggable="true" onDragOver={this.speak}>
...
var NoteDraggable = clickdrag(Note, { touch: true });
